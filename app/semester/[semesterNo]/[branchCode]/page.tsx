      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <Card className="col-span-1">
          <CardHeader className="border-b p-4">
            <CardTitle className="text-lg sm:text-xl">Student Management - {params.branch} (Semester {params.semester})</CardTitle>
          </CardHeader>
        ...
        <Card className="col-span-1">
          <CardHeader className="border-b p-4">
            <CardTitle className="text-lg sm:text-xl">Teacher Management - {params.branch} (Semester {params.semester})</CardTitle>
          </CardHeader>
          <CardContent className="p-2 sm:p-4">
            <div className="mb-4 flex flex-col space-y-2">
              <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2">
